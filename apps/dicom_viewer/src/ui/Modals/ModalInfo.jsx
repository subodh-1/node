...
const ModalInfo = (props) => {
  ...
  const slicesInfo = dicomInfo && dicomInfo.m_sliceInfo ? dicomInfo.m_sliceInfo : [];
  const tagsList = slicesInfo.length > 0 && slicesInfo[currentSlice].m_tags ? slicesInfo[currentSlice].m_tags : [];
